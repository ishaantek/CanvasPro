chrome.storage.local.get(["canvaspro-setting-quicklink"], function(data) {
  if(data["canvaspro-setting-quicklink"]) {
    console.log("[Canvas Pro] Injecting QuickLink...");
    run();
  }
});
...
function run() {
  ...
  // Line 6 = Unmodified version of QuickLink, https://github.com/GoogleChromeLabs/quicklink, available with Apache 2.0 Liscence.
  quicklink.listen();
}
