const STORAGE_PREFIX = "canvaspro-search-cache-v4-";
...
const main = async (forceReload = false) => {
  ...
  useReactiveFeatures([
    {
      settingName: "canvaspro-setting-search",
      onChanged: (value) => {
        searchContent.enabled = value;

        if (value === true) {
          if (!sessionStorage.getItem("canvaspro-search-session")) {
            sessionStorage.setItem("canvaspro-search-session", true);
          } else if (!pageLoaded) {
            pageLoaded = true;
            return;
          }
...
class SearchUI {
  ...
  createEntireElement() {
    ...
    this.wrapperElement.id = "canvaspro-search-ui-wrapper";
    this.wrapperElement.className = "canvaspro-search-ui-wrapper";
...

    {
      ...
      this.headerElementQueryRight.className =
        "canvaspro-search-ui-query-wrapper-right";
      ...
      this.headerElementQueryAutoComplete.className =
        "canvaspro-search-ui-query-wrapper-autocomplete";
...

    {
      ...
      this.resultsElement.className = "canvaspro-search-ui-results";
    ...
    //     this.widgetCenter.className = 'canvaspro-search-ui-widget-center'
    //     this.element.appendChild(this.widgetCenter)
    // }

    {
      this.controlsElement = document.createElement("div");
      this.controlsElement.className = "canvaspro-search-ui-controls";
  ...
  buildControls() {
    ...
    const buildControl = (text, icon, buttonCallback) => {
      ...
      control.classList.add("canvaspro-search-ui-controls__control");

      if (buttonCallback != null) {
        control.classList.add(
          "canvaspro-search-ui-controls__control-clickable"
        );
      ...
      controlIcon.classList.add("canvaspro-search-ui-controls__control__icon");
      controlIcon.innerHTML = icon;

      const controlLabel = document.createElement("span");
      controlLabel.classList.add(
        "canvaspro-search-ui-controls__control__label"
      );
    ...
    if (!searchContent.enabled) {
      this.controlsElement.classList.add(
        "canvaspro-search-ui-controls__Disabled"
      );
    } else {
  ...
  buildIcon() {
    const removePossibleIconClassNames = (element) => {
      [
        "canvaspro-search-ui-header-icon__loading",
        "canvaspro-search-ui-header-icon__navigator",
        "canvaspro-search-ui-header-icon__search",
      ].forEach((className) => {
    ...
    if (!searchContent.done) {
      ...
      if (
        existingClassNames.includes("canvaspro-search-ui-header-icon__loading")
      )
        reanimate = false;
      ...
      removePossibleIconClassNames(this.headerElementIcon);
      if (
        existingClassNames.includes("canvaspro-search-ui-header-icon__search")
      )
        reanimate = false;
      this.headerElementIcon.classList.add(
        "canvaspro-search-ui-header-icon__search"
  ...
  buildResult(result, idx) {
    ...
    resultElement.className = "canvaspro-search-ui-results-single-result";
    ...
    resultLeft.className = "canvaspro-search-ui-results-single-result-left";
    ...
    if (isCourseResult) {
      ...
      resultCourseCardColor.className =
        "canvaspro-search-ui-results-single-result-left-course-card-color";
      resultLeft.appendChild(resultCourseCardColor);
    }

    const resultInner = document.createElement("div");
    resultInner.className =
      "canvaspro-search-ui-results-single-result-left-inner";
    ...
    if (result.topMeta) {
      ...
      resultTopMeta.className =
        "canvaspro-search-ui-results-single-result-left-topmeta";
    ...
    if (result.course && !isCourseResult) {
      ...
      resultRight.className =
        "canvaspro-search-ui-results-single-result-right";

      const resultRightCourse = document.createElement("div");
      resultRightCourse.className =
        "canvaspro-search-ui-results-single-result-right-course";
      ...
      resultRightBreadcrumb.className =
        "canvaspro-search-ui-results-single-result-right-breadcrumb";
    ...
    if (result.hotkey) {
      ...
      resultHotkey.className =
        "canvaspro-search-ui-results-single-result-hotkey";
  ...
  buildWidget(widgetData) {
    ...
    widget.className = "canvaspro-search-ui-widget";

    if (widgetData.wide) {
      widget.classList.add("canvaspro-search-ui-widget-wide");
    }
