...
/*const surveysettings = {
    "canvaspro-setting-quicklink": "Speed+Boost",
    "canvaspro-setting-search": "Search",
    "canvaspro-setting-smartscroll": "Smart+Scrolling",
    "canvaspro-display-appearance": {'light': 'Default+(Light)', 'dim': 'Dim', 'dark': 'Lights+Out'},
    "canvaspro-setting-convopeeker": "Quick+Inbox",
    "canvaspro-setting-hidelogo": "Hide+Logo",
    "canvaspro-setting-sidebar-color": 'use default',
    "canvaspro-setting-roundermodules": "Rounder+Modules",
...
const checksettings = async () => {
    chrome.storage.local.get(Object.entries(surveysettings)[rotation][0], (data) => {
        if (data[Object.entries(surveysettings)[rotation][0]] == true) {
            ...
            //Apperance Setting
            if (Object.entries(surveysettings)[rotation][0] == "canvaspro-display-appearance") {
            ...
            //Hex Value Settings
                ...
                if (Object.entries(surveysettings)[rotation][0] == "canvaspro-setting-sidebar-color") {
                    hexurl = '&entry.1808318442';
                }
                if (Object.entries(surveysettings)[rotation][0] == "canvaspro-setting-linkcolor") {
...
const notification = async (
  ...
  notification.className = "canvaspro-notification";
...
const smallNotification = (text, emoji, colors, buttons) => {
  const notification = document.createElement("div");
  notification.className = "canvaspro-small-notification";
