...
useReactiveFeatures([
  {
    settingName: "canvaspro-setting-sidebar-color",
    onChanged: (value) => {
  ...
  {
    settingName: "canvaspro-setting-sidebar-icon-color",
    onChanged: (value) => {
      if (value !== "unset") {
  ...
  {
    settingName: "canvaspro-setting-active-sidebar-color",
    onChanged: (value) => {
  ...
  {
    settingName: "canvaspro-setting-sidebar-icon-size",
    onChanged: (value) => {
  ...
  {
    settingName: "canvaspro-setting-sidebar-more-spacing",
    onChanged: (value) => {
      sidebarIconHeight.setRule(value ? "--sidebar-icon-height: 0.75rem" : "");
    },
  },
  {
    settingName: "canvaspro-setting-sidebar-show-settings",
    onChanged: (value) => {
  ...
  {
    settingName: "canvaspro-setting-sidebar-drawer",
    onChanged: (value) => {
  ...
  {
    settingName: "canvaspro-setting-fullscreen-courses",
    onChanged: (value) => {
...
const renderSidebarDrawer = () => {
  delayedQuerySelector("#menu").then((element) => {
    ...
    chrome.storage.local.get(
      ...
      (data) => {
        if (data["canvaspro-setting-sidebar-drawer-all-items"]) {
        ...
        chrome.storage.local.set({
          "canvaspro-setting-sidebar-drawer-all-items": allItems,
        });
      }
    );
  });
...
useReactiveFeature("canvaspro-setting-sidebar-drawer-excluded", (excluded) => {
  notHidden = excluded || [];
  renderSidebarDrawer();
});
