useReactiveFeatures([
  {
    settingName: "canvaspro-setting-quizrefill",
    onChanged: (value) => {
      if (value) {
                ...
                [
                  {
                    ...
                    callback: () => {
                      if (
                        window.confirm(
                          "By using this feature, you agree to follow your school's academic honestly guidelines when using Canvas Pro."
                        )
                      ) {
                        ...
                        chrome.storage.sync.get(
                          ...
                          (data) => {
                            const newAuditLog =
                              data["canvaspro-quiz-refill-audit-log"] ?? [];
                            newAuditLog.push({
                              timestamp: Date.now(),
                            ...
                            chrome.storage.sync.set({
                              "canvaspro-quiz-refill-audit-log": newAuditLog,
                            });
                          }
                        );
                      } else {
