...
peekerBack.id = "canvaspro-convo-peeker-back"

const peekerElement = document.createElement('div')
peekerElement.id = "canvaspro-convo-peeker"
...
peekerConvoList.id = 'canvaspro-convo-peeker-convo-list'
...
const runConvoKeeper = () => {
    ...
    button.addEventListener('click', async (event) => {
        ...
        if(!document.getElementById('canvaspro-convo-peeker-convo-list')) {
...
const insertConversationTop = () => {
    ...
    top.classList = 'canvaspro-convo-peeker-convo-top'

    const header = document.createElement('b')
    header.innerText = 'Emails'

    const searchFormWrapper = document.createElement('div')
    searchFormWrapper.classList = 'canvaspro-convo-peeker-convo-top-interaction-wrapper'

    const expandLink = document.createElement('a')
    expandLink.classList = 'canvaspro-convo-peeker-convo-top-expand-link'
...
useReactiveFeatures([{
    settingName: "canvaspro-setting-convopeeker",
    onChanged: (data) => {
        if (data) {
            console.log('[Canvas Pro] Injecting email peeker ...')
            runConvoKeeper()
        } else {
